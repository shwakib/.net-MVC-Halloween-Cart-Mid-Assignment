...
namespace Ch24ShoppingCartMVC.Controllers {
    ...
    {
        private OrderModel order = new OrderModel();//object of OrderModel
        ...
        public ActionResult Index(string id) {
            ...
            if (products == null) {
                ...
                products = new SelectList(list, "ProductId", "Name", id);//ProductId from ProductViewModel
            } 
            ...
            if (string.IsNullOrEmpty(id)) {
                ...
                OrderViewModel model = order.GetOrderInfo(id);//GetOrderInfo is a method of a OrderModel that takes id as parameter
